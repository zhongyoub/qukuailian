    ...
    jQuery.ajax({
        ...
        success: function(data) {
            ...
            if (data.ret == '1') {
				...
				if (index > 0) {
					$('#link-add2Basket').replaceWith('<a href="https://big5.made-in-china.com/inquiry-basket/" target="_blank"><img border="0" src="already_in_basket_cn.gif"/*tpa=https://s.cn.made-in-china.com/resources/images/already_in_basket_cn.gif*/ alt="已加入询盘篮"/></a>');
				}
				else {
					if(SourceType == 'com'){
						$('#link-add2Basket').replaceWith('<a href="https://cn.made-in-china.com/inquiry-basket/#xunpangongsi" target="_blank"><img border="0" src="already_in_basket_cn.gif"/*tpa=https://s.cn.made-in-china.com/resources/images/already_in_basket_cn.gif*/ alt="已加入询盘篮"/></a>');

					}else{
						$('#link-add2Basket').replaceWith('<a href="https://cn.made-in-china.com/inquiry-basket/" target="_blank"><img border="0" src="already_in_basket_cn.gif"/*tpa=https://s.cn.made-in-china.com/resources/images/already_in_basket_cn.gif*/ alt="已加入询盘篮"/></a>');
